    ...
    <View style={styles.labels}>
      ...
      <FlatList 
       ...
       viewabilityConfig={{
        ...
        /* 100 significa que um item tem que estar totalmente visivel na tela ou cobrir toda a tela para contar como visivel */
       }}
...
const styles = StyleSheet.create({
    ...
    labels: {
      ...
      left: 0,
      right: 0,
      marginTop: Platform.OS === 'android' ? StatusBar.currentHeight+50 : 55,
      zIndex: 99
    },
    labelText: {
      fontSize: 16,
